...
\[1\] 헌법 제11조 제1항, 제15조, 제23조, 구 상표법(2016. 2. 29. 법률 제14033호로 전부 개정되기 전의 것) 제6조 제1항 제4호(현행 제33조 제1항 제4호 참조), 제2항(현행 제33조 제2항 참조), 상표법 제33조 제1항 제4호 / \[2\] 국제사법 제2조 / \[3\] 구 상표법(2016. 2. 29. 법률 제14033호로 전부 개정되기 전의 것) 제6조 제1항 제4호(현행 제33조 제1항 제4호 참조), 제7호(현행 제33조 제1항 제7호 참조)
...
\[1\] 대법원 2012. 12. 13. 선고 2011후958 판결(공2013상, 193), 대법원 2018. 2. 13. 선고 2017후1342 판결(공2018상, 584) / \[2\] 대법원 2011. 4. 28. 선고 2009다19093 판결(공2011상, 1007)

<!-- 원문끝:참조판례 -->

표장 이미지: [공식 첨부 파일](https://www.law.go.kr/LSW/flDownload.do?flSeq=36958970). 원문 본문의 빈 표장 자리는 그대로 두었습니다.
...
미국의 한 대학교가 「AMERICAN UNIVERSITY」라는 이름을 교육 서비스의 상표로 등록하려 했지만 거절당했습니다. 흔한 단어의 조합인지, 사람들이 특정 학교를 알아보는 이름인지가 쟁점이었습니다.

### 법원의 결론

특허청장의 상고를 받아들이지 않았습니다. 이 이름이 문제 된 등록 거절 사유에 해당하지 않는다는 앞선 판단이 유지됐습니다.

**지리적 이름과 대학교라는 단어를 붙이면 언제나 등록되나요? → NO**

결합했다는 사실만으로 새로운 식별력이 자동 생기는 것은 아닙니다.

**전체 이름이 특정 학교를 가리키는지 등을 봐야 하나요? → YES**

전체가 주는 의미와 지정서비스업, 국내 수요자의 인식을 함께 봅니다.
...
| 사용할 재료 | 이 사건에서 하는 일 |
|---|---|
| 정보·자료 이해 | 등록하려는 이름, 실제 이미지, 사용할 서비스 종류를 확인합니다. |
| 못 찾음·없음 구분 | 그림이 없는 것과 그림을 못 받은 것을 구별합니다. |
| 업무별 정보 | 국내에서 그 이름이 어느 학교를 뜻하는지에 관한 자료를 모읍니다. |
| 기준 적용·판정 | 단어를 따로 떼지 않고 이름 전체와 사용할 서비스를 함께 판단합니다. |
| 결과 검증·재검증 | 실제로 확인한 이미지와 자료만으로 설명했는지 검사합니다. |

**새 재료를 추가해야 하나? → NO**

이 사건에서 추가가 꼭 필요한 새 재료는 찾지 못했습니다.

**기존 재료에 보완할 내용이 있나? → YES**

이름만 남고 이미지나 서비스 종류가 빠졌다면 자료를 다시 받아야 합니다. 비슷한 로고를 추측해서 채우면 안 됩니다.

**순서도나 시험 조건도 고칠 곳이 있나? → YES**

- 재료 대응표는 77개로 남아 있습니다. 본문에 이미 있는 「못 찾음·없음 구분」과 「보고 주체 확인」을 표에도 넣어야 합니다.
- 필수 검사를 못 했는데 채점으로 넘어가는 길을 고쳐야 합니다. 필요한 자료를 받거나 다른 검사로 확인하기 전에는 완료로 처리하면 안 됩니다.

*재료 검토 기준: 79개 · 2026-09-18 08:49 보관본 · 실제 실행 시험: 미실시*
